...
loSession = CREATEOBJECT("_hr05501")
...
ENDPROC
**********
DEFINE CLASS _hr05501 AS HotelSession OF ProcMultiProper.prg
...
And	iif(empty(min2), inlist(hr_status, "DEF","OPT","ASG","6PM","IN"), hr_status = min2)
order by 1
ENDTEXT
