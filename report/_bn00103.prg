...
loSession = CREATEOBJECT("_bn00103")
...
ENDPROC
**********
DEFINE CLASS _bn00103 AS HotelSession OF ProcMultiProper.prg
...
Select  iif(hp_paynum=0,1,0) as art,
	bn_billnum, bn_reserid, bn_addrid, bn_amount, bn_history, bn_status, bn_date, bn_window, bn_apid, 
...
order by art,hp_paynum, hp_artinum
ENDTEXT
