 ...
 * From now, make sure no error occurs, when updating PostgreSQL
 ...
 IF DB_LOWER_VER = CompareVersion("10.1.3")
      IF OpenFileDirect(,"picklist") AND NOT SEEK("GSGVO     ","picklist","tag1")
           ...
           SqlInsert("picklist", "pl_label, pl_numcod, pl_lang3, pl_lang1, pl_lang2, pl_lang4, pl_lang5, pl_lang6, pl_lang7, pl_lang8, pl_lang9, pl_lang10, pl_lang11", 1, "'GSGVO', 4, 'mündlich erteilt'" + REPLICATE(", 'orally granted'", 10))
           SqlInsert("picklist", "pl_label, pl_numcod, pl_lang3, pl_lang1, pl_lang2, pl_lang4, pl_lang5, pl_lang6, pl_lang7, pl_lang8, pl_lang9, pl_lang10, pl_lang11", 1, "'GSGVO', 5, 'zurückgenommen'" + REPLICATE(", 'redeemed'", 10))
      ENDIF
 ENDIF
...
Wir bitten Sie daher, Ihre Zahlung nunmehr innerhalb der nächsten 8 Tage auf das
...
Wir müssen Sie daher bitten, den Rechnungsbetrag nunmehr unverzüglich auf das unten stehende Konto
zu überweisen.
...
5 Tagen auf das unten stehende Konto zu überweisen.
